...
public class LoginController {
    ...
    public void signUpButtonOnAction(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/icms/signup.fxml"));
    ...
    public void loadAdminHomePage() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/icms/view/AdminHomepage.fxml"));
            Parent root = fxmlLoader.load();
